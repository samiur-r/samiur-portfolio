    ...
    <section id="projects" className="bg-[#0f3443] py-8">
      <div className="container mx-auto flex flex-wrap pt-4 pb-12">
        ...
        <div className="mx-auto grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-4">
          {projects.map((post) => (
            <Link key={post.id} href={`/project/${post.slug}`}>
              <article className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pb-8 pt-80 sm:pt-48 lg:pt-80 hover:opacity-80 transition-opacity duration-300">
                <Image
                  layout="fill"
                  src={post.thumbnail}
                  alt="project"
